    ...
    public partial class Form1 : Form
    {
        ...
        private void mover(object sender, MouseEventArgs e)
        {
            ...
            if (sender == button1)
            {
                ...
                Text = String.Format(" Mouse Tester X:{0}, Y:{1} ", button1.Location.X + e.Location.X, button1.Location.Y + e.Location.Y);
            ...
            else if (sender == button2)
            {
                ...
                Text = String.Format(" Mouse Tester X:{0}, Y:{1} ", (button2.Location.X + e.Location.X), (button2.Location.Y + e.Location.Y));
            }
            else
            {
